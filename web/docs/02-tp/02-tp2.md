...
Pour vous guider, veuillez vous référer à la démonstration suivante en double-cliquant sur l'exécutable `.exe` : [démo tp2](../../static/files/laboratoires/Demonstration_tp2.zip)
