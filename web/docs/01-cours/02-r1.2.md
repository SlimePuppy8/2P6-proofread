...
| Passive | UI:R | Un utilisateur doit faire une action, mais c'est une action qu'il ferait normalement. |
| Active | UI:R | Un utilisateur doit faire une action alors qu'il comprend qu'elle pourrait être problèmatique. |
...
- Conditions requises pour réussir l'attaque: aucurne
