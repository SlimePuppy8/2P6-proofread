...
Au cours des séances, nous aurons des exercices / CTF (_Capture The Flag_) à réaliser.
...
:::warning
Ignorez simplement les mots des passes qui n'ont pas pu être craqués
:::
...
:::warning
Si vous ne l'avez pas eu du premier coup, vous pouvez essayer encore
:::
...
1. Produire le hash MD5 de "bits bits bits hash hash hash" ce qui te donne **hash** avec [ce générateur de hachage MD5](https://webutility.io/md5-hash-generator-with-salt)
...
<details>
<summary>Un mot de passe court et incassable! (par CrackStation....)</summary>
...
- Prendre également une capture d'écran prouvant que Crack Station ne peut pas le craquer

:::warning
Pas de CTF cette fois, faites simplement le prochain exercice et ensuite vous pouvez montrer votre résultat à votre enseignant.
:::

</details>

<details>
<summary>Salé, mais pas top...</summary>
...
:::warning
C'est bon pour les exercices d'aujourd'hui, simplement montrer à votre enseignant que vous avez terminé les CTFs et trouvez les 2 dernières réponses.
:::
